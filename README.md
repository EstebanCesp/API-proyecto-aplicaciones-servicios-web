# API_aplicaciones_servicios_web - API REST Generica Multi-Base de Datos
...
cd API_aplicaciones_servicios_web
```
...
```
API_aplicaciones_servicios_web/
|-- Controllers/
...
|-- API_aplicaciones_servicios_web.csproj          # Definicion del proyecto y paquetes NuGet
|-- API_aplicaciones_servicios_web.sln             # Solucion de Visual Studio
|-- API_aplicaciones_servicios_web.http            # Archivo de pruebas HTTP (VS Code REST Client)
